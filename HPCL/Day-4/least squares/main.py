...
if __name__ == "__main__":
    ...
    # Choose an optimizer
    optimizer = torch.optim.Adam([model.alphas], lr=0.01)
    ...
    for epoch in tqdm(range(epochs)):
        ...
        # Plot it out
        generate_multiple_scatter_plots(data_module.X_test[:,0], data_module.Y_test, final_preds, "predicted_test"+str(epoch))
